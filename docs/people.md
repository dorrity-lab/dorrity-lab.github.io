...
<div class="pi-hero">
  <a href="dorrity/"><img src="../assets/images/people/dorrity.jpg" alt="Michael Dorrity" class="pi-hero-photo"></a>
  <div class="pi-hero-info">
    <h2 class="pi-hero-name">Michael Dorrity</h2>
    <p class="pi-hero-role">Group Leader</p>
    <p class="pi-hero-bio">As a Group Leader in the Molecular Systems Biology Unit at EMBL Heidelberg, I generate multi-scale representations of developmental processes in order to measure temporal shifts associated with deleterious or novel phenotypes. My group uses a combination of time-resolved single-cell genomics, biochemistry, and computational biology.</p>
...
<a href="bucao/" class="person-face-card">
  <div class="person-face-inner">
    ...
    <div class="person-face-overlay">
      <p class="person-face-name">Christabel Bucao</p>
      <p class="person-face-role">Postdoc</p>
    </div>
  </div>
</a>
...
<a href="welz/" class="person-face-card">
  <div class="person-face-inner">
    <img src="../assets/images/people/Bettina_Welz.jpeg" alt="Bettina Welz" class="person-face-photo">
    <div class="person-face-overlay">
      <p class="person-face-name">Bettina Welz</p>
      <p class="person-face-role">Postdoc</p>
    </div>
  </div>
</a>
...
<a href="hernandez/" class="person-face-card">
  <div class="person-face-inner">
    <img src="../assets/images/people/Luis_Hernandez.jpg" alt="Luis Hernandez-Huertas" class="person-face-photo">
    <div class="person-face-overlay">
      <p class="person-face-name">Luis Hernandez-Huertas</p>
      <p class="person-face-role">Postdoc</p>
    </div>
  </div>
</a>
...
<a href="perez/" class="person-face-card">
  <div class="person-face-inner">
    <img src="../assets/images/people/Julio_Perez.jpg" alt="Julio Perez" class="person-face-photo">
    <div class="person-face-overlay">
      <p class="person-face-name">Julio Perez</p>
      <p class="person-face-role">Postdoc</p>
    </div>
  </div>
</a>
...
<a href="benjaminsen/" class="person-face-card">
  <div class="person-face-inner">
    <img src="../assets/images/people/Joergen_Benjaminsen.png" alt="Joergen Benjaminsen" class="person-face-photo">
    <div class="person-face-overlay">
      <p class="person-face-name">Joergen Benjaminsen</p>
      <p class="person-face-role">Postdoc (joint, Wittbrodt lab)</p>
    </div>
  </div>
</a>
...
<a href="herrera/" class="person-face-card">
  <div class="person-face-inner">
    <img src="../assets/images/people/Santi_Herrera.webp" alt="Santiago Herrera-Alvarez" class="person-face-photo">
    <div class="person-face-overlay">
      <p class="person-face-name">Santiago Herrera-Alvarez</p>
      <p class="person-face-role">Postdoc (joint, Crocker lab)</p>
    </div>
  </div>
</a>
...
<a href="bourn/" class="person-face-card">
  <div class="person-face-inner">
    <img src="../assets/images/people/jess.jpg" alt="Jess Bourn" class="person-face-photo">
    <div class="person-face-overlay">
      <p class="person-face-name">Jess Bourn</p>
      <p class="person-face-role">PhD Student</p>
    </div>
  </div>
</a>
...
<a href="vaidya/" class="person-face-card">
  <div class="person-face-inner">
    <img src="../assets/images/people/gaurav.jpg" alt="Gaurav Vaidya" class="person-face-photo">
    <div class="person-face-overlay">
      <p class="person-face-name">Gaurav Vaidya</p>
      <p class="person-face-role">PhD Student</p>
    </div>
  </div>
</a>
...
<a href="petrasiunaite/" class="person-face-card">
  <div class="person-face-inner">
    <img src="../assets/images/people/vesta.jpg" alt="Vesta Petrasiunaite" class="person-face-photo">
    <div class="person-face-overlay">
      <p class="person-face-name">Vesta Petrasiunaite</p>
      <p class="person-face-role">PhD Student</p>
    </div>
  </div>
</a>
...
<a href="mayer/" class="person-face-card">
  <div class="person-face-inner">
    <img src="../assets/images/people/Marvin_Mayer.png" alt="Marvin Mayer" class="person-face-photo">
    <div class="person-face-overlay">
      <p class="person-face-name">Marvin Mayer</p>
      <p class="person-face-role">PhD Student</p>
    </div>
  </div>
</a>
...
<a href="hsing/" class="person-face-card">
  <div class="person-face-inner">
    ...
    <div class="person-face-overlay">
      <p class="person-face-name">Jeni Hsing</p>
      <p class="person-face-role">PhD Student</p>
    </div>
  </div>
</a>
...
<a href="espinosa/" class="person-face-card">
  <div class="person-face-inner">
    ...
    <div class="person-face-overlay">
      <p class="person-face-name">Lot Hernandez Espinosa</p>
      <p class="person-face-role">PhD Student</p>
    </div>
  </div>
</a>
...
<a href="seyda/" class="person-face-card">
  <div class="person-face-inner">
    ...
    <div class="person-face-overlay">
      <p class="person-face-name">Cem Seyda</p>
      <p class="person-face-role">Scientific Trainee</p>
    </div>
  </div>
</a>
...
<a href="kellas/" class="person-face-card">
  <div class="person-face-inner">
    <img src="../assets/images/people/Will_Kellas.jpg" alt="Will Kellas" class="person-face-photo">
    <div class="person-face-overlay">
      <p class="person-face-name">Will Kellas</p>
      <p class="person-face-role">Research Intern</p>
    </div>
  </div>
</a>
...
<a href="tarcsa/" class="person-face-card">
  <div class="person-face-inner">
    ...
    <div class="person-face-overlay">
      <p class="person-face-name">Virag Tarcsa</p>
...
<a href="ishibashi/" class="person-face-card">
  <div class="person-face-inner">
    <img src="../assets/images/people/Ojiro_Ishibashi.jpeg" alt="Ojiro Ishibashi" class="person-face-photo">
    <div class="person-face-overlay">
      <p class="person-face-name">Ojiro Ishibashi</p>
      <p class="person-face-role">Research Intern</p>
    </div>
  </div>
</a>
...
<a href="eila/" class="person-face-card">
  <div class="person-face-inner">
    <img src="../assets/images/people/Eila2.JPG" alt="Eila" class="person-face-photo">
    <div class="person-face-overlay">
      <p class="person-face-name">Eila</p>
      <p class="person-face-role">Lab Dog</p>
    </div>
  </div>
</a>
